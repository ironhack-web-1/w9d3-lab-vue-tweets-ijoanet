<template>
  <div class="app">
    <Tweet v-for="(tweet, idx) in tweets" :key="idx" :user="tweet.user" :timestamp="tweet.timestamp" :message="tweet.message" />
  </div>
</template>

<script>

import Tweet from './components/TweetComponent.vue';
